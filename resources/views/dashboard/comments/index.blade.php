        ...
        <div class="col-md-12 col-lg-10">
          <div class="card text-dark">
            ...
            <div class="card-body p-4">
              ...
              <p class="fw-light mb-4 pb-2">Latest Comments section by me</p>
              ...
              <div class="d-flex flex-start">
                ...
                <div>
                  ...
                  <div class="d-flex align-items-center mb-3">
                    ...
                    {{-- <a href="/dashboard/comments/{{ $comment->id }}/edit" class="badge bg-warning mx-2"><i data-feather="edit"></i></a> --}}

                    {{-- <form action="/dashboard/comments/{{ $comment->id }}" method="post" class="d-inline"> --}}
                        @method('delete')
                        @csrf
                        <a href="" class="badge bg-danger" onclick="return confirm('Apakah Anda yakin ingin komentar ini?')"><i  data-feather="delete"></i></a>
                    </form>
