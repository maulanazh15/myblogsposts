    ...
    >
            ...
            <div class="mb-10 w-full">
              ...
              <ul class="flex flex-wrap items-center">
                <li>
                  ...
                  >
                    <img
                      src="img/footer/brands/tailgrids.svg"
                      alt="tailgrids"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="img/footer/brands/ayroui.svg"
                      alt="ayroui"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="img/footer/brands/ecommerce-html.svg"
                      alt="ecommerce-html"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="img/footer/brands/graygrids.svg"
                      alt="graygrids"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="img/footer/brands/lineicons.svg"
                      alt="lineicons"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="img/footer/brands/uideck.svg"
                      alt="uideck"
                    />
                  </a>
                </li>
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="img/footer/shape-1.svg" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="img/footer/shape-3.svg" alt="" />
        </span>
